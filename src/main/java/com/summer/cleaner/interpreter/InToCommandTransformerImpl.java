...
public class InToCommandTransformerImpl
    implements InToCommandTransformer {

  @Override
  public List<Pair<String, Object>> exec(List<String> commandStrings) {
  ...
  private void parseCommandWithArg(
