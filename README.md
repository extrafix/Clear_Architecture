...
У меня по-прежнему осталась переменная в CommandInterpreter, но она изменяется только внутри исполнения метода и в нем же и иницилизируется по занчению из EventStorage.  
